...
const NavigatingtheupdatedHUBZoneMap = () => {
  return (
    <div className="bg-white rounded-3xl">
      <div className="flex items-center border-b p-8">
        <div className="text-4xl font-medium">Navigating the updated HUBZone Map</div>
...
export default NavigatingtheupdatedHUBZoneMap;
