...
const Learn = () => {
  ...
  return (
    <div className="px-4 md:px-14">
      <div className="font-semibold italic text-4xl md:text-[55px] text-center text-primary md:pt-32 pt-12 pb-12 border-b border-gray-300">
        FEDERAL FORECASTING TRAINING VIDEOS
      </div>
      <div className="grid md:grid-cols-3 gap-8 md:gap-16 pt-16">
        {dummyData.map((data) => (
          <div key={data}>
            <div className="w-full h-80 bg-gray-600"></div>
            <div className="md:text-2xl pt-8 font-medium whitespace-pre-line">
              {data}
            </div>
          </div>
        ))}
